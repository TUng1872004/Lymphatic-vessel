...
class Data_Generator(Dataset):
    def __init__(self, withAug = True, validate = False):
        self.data = []
        self.pic = []
        self.val =[]
        self.validate = validate
        self.transform = A.Compose([
        A.SmallestMaxSize(max_size=280, p=1.0),
...
if __name__ == '__main__':
    ...
    cv2.imwrite("merge.png",loader.merge(img, mask))
